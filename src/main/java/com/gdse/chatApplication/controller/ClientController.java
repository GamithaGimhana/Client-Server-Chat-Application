...
//        );
    ...
    void btnSendOnClick(ActionEvent event) throws IOException {
        uMessage = txtInput.getText();
        txtChat.appendText("User's Messege : " + uMessage + "\n");
        dataOutputStream = new DataOutputStream(socket.getOutputStream());
        dataOutputStream.writeUTF(uMessage);
        dataOutputStream.flush();
    }
...
//                String sMessege;
//                do {
//                    sMessege = dataInputStream.readUTF();
//                    txtChat.appendText("Server's Messege : " + sMessege + "\n");
//                } while (!sMessege.equals("bye"));
